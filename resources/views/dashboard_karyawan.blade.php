        ...
        <div class="container">
            <div class="text-center"><h2 class="mt-5">Main Menu</h2></div>
                <div class="d-flex flex-row justify-content-center">
                    ...
                    <a class="btn btn-outline-dark m-2" href="{{ route('absensiKamera') }}" role="button">Absensi Wajah <i class="fa fa-user-circle-o" aria-hidden="true"></i><i class="fas fa-camera-alt" aria-hidden="true"></i></a>
            </div>
        </div>
    </main>
